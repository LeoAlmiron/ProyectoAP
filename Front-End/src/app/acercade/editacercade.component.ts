...
export class EditacercadeComponent implements OnInit {
  ...
  this.personaService.detail(id).subscribe(data =>{ this.persona = data;}, err =>{("Error al modificar");
  ...
  onUpdate(): void{
    ...
    this.personaService.update(id, this.persona).subscribe(data => {this.router.navigate(['']);}, err =>{alert("Error al modificar la persona");
  this.router.navigate(['']);})
  }
